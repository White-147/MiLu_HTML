...
@click.group(
    ...
    lazy_subcommands={
        "app": ("milu.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "milu.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("milu.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("milu.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("milu.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("milu.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("milu.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("milu.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("milu.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "milu.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("milu.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "milu.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("milu.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("milu.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "milu.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("milu.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("milu.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("milu.cli.agents_cmd", "agents_group", ".agents_cmd"),
    },
)
@click.version_option(version=__version__, prog_name="MiLu")
