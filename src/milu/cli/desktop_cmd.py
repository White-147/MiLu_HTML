# -*- coding: utf-8 -*-
"""CLI command: run MiLu app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run MiLu app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing MiLu app instance.
    """
    ...
    click.echo(f"Starting MiLu app on {url} (port {port})")
