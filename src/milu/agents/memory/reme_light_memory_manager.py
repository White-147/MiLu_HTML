...
# mypy: ignore-errors
"""ReMeLight-backed memory manager for milu agents."""
...
from milu.agents.memory.base_memory_manager import BaseMemoryManager
from milu.agents.model_factory import create_model_and_formatter
from milu.agents.tools import read_file, write_file, edit_file
from milu.agents.utils import get_milu_token_counter
from milu.config import load_config
from milu.config.config import load_agent_config
from milu.config.context import (
    set_current_workspace_dir,
    set_current_recent_max_bytes,
)
from milu.constant import EnvVarLoader
...
class ReMeLightMemoryManager(BaseMemoryManager):
    """Memory manager that wraps ReMeLight for milu agents via composition.
        ...
        **_kwargs,
        ...
        if extra_instruction:
            result = await self._reme.compact_memory(
                ...
                as_token_counter=get_milu_token_counter(agent_config),
        ...
        if not result.get("is_valid", True):
            ...
            try:
                ...
                logger.error(
                    ...
                    "https://github.com/agentscope-ai/milu/issues",
                )
