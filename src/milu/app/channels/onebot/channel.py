...
OneBot v11 implementation.  milu listens on a configurable port;
...
class OneBotChannel(BaseChannel):
    ...
    milu acts as a WebSocket server; NapCat (or compatible) connects
    ...
    def _parse_message_segments(
        ...
        """Parse OneBot v11 message segments to milu content_parts.
