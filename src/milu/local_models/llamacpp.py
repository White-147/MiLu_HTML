...
from milu.constant import DEFAULT_LOCAL_PROVIDER_DIR
from milu.providers.provider import ModelInfo
...
class LlamaCppBackend:
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"milu-llamacpp-download-{staging_dir.name}",
            command=["milu-llamacpp-download", download_url],
